<?php  
 ...
 {  
      ...
      {  
           ...
           $procedure = "  
                CREATE PROCEDURE insertUser(IN firstName varchar(250), lastName varchar(250), audio varchar(250), smartboards varchar(250), ac varchar(250), internet varchar(250))  
                BEGIN  
           ...
           {  
                ...
                {  
                     $query = "CALL insertUser('".$first_name."', '".$last_name."', '".$audio."','".$smart_boards."', '".$A_C."',  '".$I_N."')";  
      ...
      {  
           ...
           $I_N = mysqli_real_escape_string($connect, $_POST["internet"]);
           $procedure = "  
                CREATE PROCEDURE updateUser(IN user_id int(11), firstName varchar(250), lastName varchar(250), audio varchar(250), smartboards varchar(250), ac varchar(250), internet varchar(250))  
                BEGIN   
           ...
           {  
                if(mysqli_query($connect, $procedure))  
                {  
                     $query = "CALL updateUser('".$_POST["id"]."', '".$first_name."', '".$last_name."','".$audio."','".$smart_boards."', '".$A_C."', '".$I_N."')";  
                     mysqli_query($connect, $query);  
                     echo 'Data Updated';  
                }  
           }  
      ...
      {  
           ...
           BEGIN   
           DELETE FROM equip WHERE id = user_id;  
           END;  
           ";  
